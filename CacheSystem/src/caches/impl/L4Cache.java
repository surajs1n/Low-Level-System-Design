...
public class L4Cache implements Cache<String, Event> {

    private final static int MAX_SIZE = 100;
    private final CacheType cacheType = CacheType.L4;
    ...
    public Event fetchEvent(String key) {
        ...
        if (fetchedEvent == null) {
            System.out.println("[L4Cache] Event doesn't exist for key: " + key);
        }
